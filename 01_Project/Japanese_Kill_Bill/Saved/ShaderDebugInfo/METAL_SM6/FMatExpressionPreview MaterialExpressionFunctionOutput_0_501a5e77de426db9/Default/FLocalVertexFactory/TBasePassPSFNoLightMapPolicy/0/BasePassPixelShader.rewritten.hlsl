// DebugHash_1aeac14fa2a7ec9934903f0414396296fd35eb0635ff5c4a888bd7bb52d54942
...
_Pragma("dxc diagnostic push")
_Pragma("dxc diagnostic ignored \"-Wall\"") 					_Pragma("dxc diagnostic ignored \"-Wconversion\"") 				_Pragma("dxc diagnostic ignored \"-Wfor-redefinition\"") 		_Pragma("dxc diagnostic ignored \"-Winline-asm\"")				_Pragma("dxc diagnostic ignored \"-Wunsequenced\"")
	float Local0 = (View_GameTime * Material_PreshaderBuffer[0].x);
	float Local1 = (Local0 * 6.28318548f);
	float Local2 = sin(Local1);
	float Local3 = (View_GameTime * Material_PreshaderBuffer[0].y);
	float Local4 = (Local3 * 6.28318548f);
	float Local5 = sin(Local4);
	float Local6 = (  Local2  +   Local5 );
	float Local7 = (  Local6  * 0.50000000f);
	float Local8 = lerp(0.75000000f,1.00000000f,  Local7 );
	float3 Local9 = Parameters.TangentToWorld[2];
	FSubstrateData Local10 = SubstrateConvertLegacyMaterialStatic(Parameters.SubstratePixelFootprint,
			                         float3(0.00000000f,0.00000000f,0.00000000f),
			                          0.50000000f,
			                          0.00000000f,
			                         0.50000000f,
			                        0.00000000f,
			                   float3(1.00000000f,1.00000000f,1.00000000f),
			               ExtractSubsurfaceProfileInt(Material_PreshaderBuffer[0].z),
			                         1.00000000f,
			                0.10000000f,
			                       Local8 ,
			                           1.00000000f,
			 float3(0.50000000f,0.50000000f,0.50000000f),
			    1.00000000f,
			       float3(0.00000000f,0.00000000f,0.00000000f),
			       float3(0.00000000f,0.00000000f,0.00000000f),
			                       0.00000000f,
			             float3(1.00000000f,1.00000000f,1.00000000f),
			                    ...
			                    Local9 ,
			               Local9 ,
			                   SHAREDLOCALBASIS_INDEX_0_0,
			   SHAREDLOCALBASIS_INDEX_0_0,
			Parameters.SharedLocalBases.Types)
			;
	float3 Local11 = Local10.PreviewColor;
	float3 Local12 = max(Local11,((float3)0.00000000f));
	float3 Local13 = PositiveClampedPow(Local12,((float3)0.45454544f));
	...
	PixelMaterialInputs.Refraction = float3(float3(1.00000000f,0.0f,0.0f).xy,Material_PreshaderBuffer[0].w);
